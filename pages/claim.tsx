  ...
  return (
    <div className="bg-cover bg-center min-h-screen" style={{ backgroundImage: `url('images/bg-paal.png')` }}>
      <div>
        ...
        <p className="flex justify-center text-white">Complete Claim</p>
        <br />
        <div className="flex justify-center items-center">
          <br />
          <Web3Button
            ...
            action={() =>
              mutateAsync({
                overrides: {
                  value: utils.parseEther(parsedBalx), // send 0.1 native token with the contract call
                },
              })
            }
          >Complete Claim</Web3Button>
          &nbsp;&nbsp;
          <select
